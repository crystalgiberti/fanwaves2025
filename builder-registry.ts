...
const Layout = dynamic(() =>
  import("./client/components/Layout").then((mod) => ({
    default: mod.default,
  })),
);

const Button = dynamic(() =>
  import("./client/components/ui/button").then((mod) => ({
    default: mod.Button,
  })),
);
...
const HeroSection = dynamic(() =>
  import("./client/components/builder/AdvancedComponents").then((mod) => ({
...
const TeamStats = dynamic(() =>
  import("./client/components/builder/AdvancedComponents").then((mod) => ({
    default: mod.TeamStats,
  })),
);

const FeatureList = dynamic(() =>
  import("./client/components/builder/AdvancedComponents").then((mod) => ({
    default: mod.FeatureList,
  })),
);
        ...
        defaultValue: [
          {
            ...
            description:
              "Official licensed merchandise from your favorite teams",
            icon: "✅",
          },
          {
            title: "Fast Shipping",
