...
const teams = [
  ...
  },
  {
    ...
    colors: { primary: "#BB0000", secondary: "#C0C0C0" },
    league: "NCAA",
  },
  {
    value: "tigers-clemson",
    label: "Clemson Tigers",
    colors: { primary: "#F66733", secondary: "#522D80" },
    league: "NCAA",
  },
  {
  ...
  },
  {
    ...
    colors: { primary: "#841617", secondary: "#FDD023" },
    league: "NCAA",
  },
  {
    value: "longhorns",
  ...
  },
  {
    ...
    colors: { primary: "#F47321", secondary: "#046A38" },
    league: "NCAA",
  },
  {
    value: "seminoles",
  ...
  },
  {
    value: "bruins",
    label: "UCLA Bruins",
    colors: { primary: "#2D68C4", secondary: "#FFD100" },
    league: "NCAA",
  },
  {
    value: "trojans",
  ...
  },
  {
    ...
    colors: { primary: "#8C1515", secondary: "#DAA900" },
    league: "NCAA",
  },
  {
    value: "ducks",
...
const productTypes = [
  ...
  {
    value: "womens-jersey",
    label: "Women's Jersey",
    basePrice: 84.99,
    category: "Jerseys",
  },
  {
    value: "practice-jersey",
...
const fontFamilies = [
  // Classic Sports Fonts
  {
    ...
    label: "Impact (Classic Sports)",
    category: "Sports",
  },
  {
    value: "Anton, Impact, sans-serif",
    label: "Anton (Bold Sports)",
    category: "Sports",
  },
  {
    value: "Bebas Neue, Arial Black, sans-serif",
    label: "Bebas Neue (Modern Sports)",
    category: "Sports",
  },
  {
    value: "Oswald, Impact, sans-serif",
    label: "Oswald (Athletic)",
    category: "Sports",
  },
  {
    value: "Teko, Arial Black, sans-serif",
    label: "Teko (Jersey Style)",
    category: "Sports",
  },
  {
    value: "Fjalla One, Arial Black, sans-serif",
    label: "Fjalla One (Strong)",
    category: "Sports",
  },
  {
    value: "Russo One, Impact, sans-serif",
    label: "Russo One (Retro Sports)",
    category: "Sports",
  },
  {
    value: "Squada One, Arial Black, sans-serif",
    label: "Squada One (Varsity)",
    category: "Sports",
  },
  ...
  // Bold & Condensed
  {
    ...
    label: "Arial Black (Bold)",
    category: "Bold",
  },
  {
    value: "Franklin Gothic Medium, Arial, sans-serif",
    label: "Franklin Gothic (Football)",
    category: "Bold",
  },
  {
    value: "Trebuchet MS, Arial, sans-serif",
    label: "Trebuchet MS (Clean Bold)",
    category: "Bold",
  },
  {
    value: "Helvetica Neue Condensed, Arial, sans-serif",
    label: "Helvetica Condensed",
    category: "Bold",
  },
  {
    value: "Compacta, Arial Black, sans-serif",
    label: "Compacta (Compressed)",
    category: "Bold",
  },
  ...
  // Display & Decorative
  {
    ...
    label: "Bangers (Comic Style)",
    category: "Display",
  },
  {
    value: "Righteous, cursive",
    label: "Righteous (Retro)",
    category: "Display",
  },
  {
    value: "Bungee, cursive",
    label: "Bungee (3D Effect)",
    category: "Display",
  },
  {
    value: "Fredoka One, cursive",
    label: "Fredoka One (Friendly Bold)",
    category: "Display",
  },
  ...
  },
  {
    ...
    label: "Play (Tech Style)",
    category: "Stencil",
  },
  {
    value: "Audiowide, cursive",
    label: "Audiowide (Digital)",
    category: "Stencil",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Create unique, personalized merchandise for your favorite team.
            Design it your way, order it today!
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <Select
                  value={design.team}
                  onValueChange={(value) => updateDesign({ team: value })}
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    updateDesign({ productType: value })
                  }
                >
                  <SelectTrigger>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateDesign({ fontSize: parseInt(e.target.value) })
                    }
                    className="w-full"
                  />
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    ...
                    <SelectContent className="max-h-60 overflow-y-auto">
                      {["Sports", "Bold", "Display", "Classic", "Stencil"].map(
                        (category) => (
                          <div key={category}>
                            <div className="px-2 py-1 text-xs font-semibold text-muted-foreground bg-muted/50">
                              {category} Fonts
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    <Button
                      onClick={addToCart}
                      disabled={
                        !selectedTeam || !selectedProduct || !design.customText
                      }
