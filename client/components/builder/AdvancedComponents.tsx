  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        ...
        <div
          className="absolute top-40 right-20 w-16 h-16 bg-white/10 rounded-full floating-icon"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-20 left-20 w-24 h-24 bg-white/10 rounded-full floating-icon"
      ...
      <div className="container mx-auto px-4">
        ...
        >
          {props.teams.map((team, index) => (
            <a key={index} href={team.link} className="team-card-hover block">
                ...
                <div className="relative aspect-square overflow-hidden rounded-t-lg bg-muted">
                  ...
                  {product.badge && (
                    <Badge
                      ...
                      style={{
                        backgroundColor: product.badgeColor || "#00d4ff",
                      }}
                    >
                      {product.badge}
                    </Badge>
